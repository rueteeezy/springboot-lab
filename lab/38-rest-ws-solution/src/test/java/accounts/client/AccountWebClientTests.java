...
class AccountWebClientTests {
	...
	@Test
	void listAccounts_WebClient_exchange_blocking() {
	...
	@Test
	void getAccount_WebClient_retrieve_blocking() {
	...
	@Test
	void getAccount_WebClient_exchange_blocking() {
	...
	@Test
	void createAccount_WebClient_blocking() throws Exception {
	...
	@Test
	void createSameAccountTwiceResultsIn409_WebClient_blocking() {
	...
	@Test
	void addAndDeleteBeneficiary_WebClient_blocking() throws Exception {
